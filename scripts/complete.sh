...
VAE_MODELS=(
    "https://huggingface.co/ffxvs/vae-flux/resolve/main/ae.safetensors" # F.lux
)
...
TEXT_ENCODERS=(
    "https://huggingface.co/calcuis/wan-gguf/resolve/main/t5xxl_um_fp8_e4m3fn_scaled.safetensors" # WAN
    "https://huggingface.co/comfyanonymous/flux_text_encoders/resolve/main/t5xxl_fp8_e4m3fn.safetensors" # F.lux
)
